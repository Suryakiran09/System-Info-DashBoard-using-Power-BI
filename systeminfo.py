...
while 1==1:
    ...
    con.commit()
    print(str(cpu_usage) + " " + str(memory_usage) + " " + str(cpu_interrupts) + " " + str(cpu_calls) + " " + str(memory_used) + " " + str(memory_free) + " " + str(bytes_sent) + " " + str(bytes_received) + " " + str(disk_usage))
    time.sleep(1)
